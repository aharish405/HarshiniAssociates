...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-40 w-full glass-navbar transition-all duration-300">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-20 left-0 w-full bg-[var(--bg-secondary)] border-b border-t border-[var(--border-color)] py-6 px-4 space-y-4 animate-fade-in-down shadow-2xl">
          <button 
            onClick={() => scrollToSection('hero')} 
